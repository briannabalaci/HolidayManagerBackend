...
@PreAuthorize("hasAuthority(T(com.internship.holiday_manager.entity.enums.UserType).EMPLOYEE)" +
        "or hasAuthority(T(com.internship.holiday_manager.entity.enums.UserType).TEAMLEAD)" +
        "or hasAuthority(T(com.internship.holiday_manager.entity.enums.UserType).ADMIN)")
